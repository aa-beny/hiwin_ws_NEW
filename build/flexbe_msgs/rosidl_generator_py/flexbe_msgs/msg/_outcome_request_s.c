...
bool flexbe_msgs__msg__outcome_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flexbe_msgs.msg._outcome_request.OutcomeRequest", full_classname_dest, 47) == 0);
  }
  flexbe_msgs__msg__OutcomeRequest * ros_message = _ros_message;
  {  // outcome
...
{
  /* NOTE(esteve): Call constructor of OutcomeRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("flexbe_msgs.msg._outcome_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OutcomeRequest");
